...
public class leaderforgotpswrd extends AppCompatActivity implements
...
///private TextView mDetailText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (forgetPassword != null) {
            user = forgetPassword.getString("userid_id");
            ...
            public void onClick(View view) {
                ...
                fb_to_read.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                       ...
                       // Toast.makeText(com.example.thozhilurapplastfinal.leaderforgotpswrd.this, mobileNumberString, Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent changePasssword = new Intent(com.example.thozhilurapplastfinal.leaderforgotpswrd.this, leadereditpassword.class);
